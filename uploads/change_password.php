...
<body>
    ...
    function showPage($reason)
    {
        ...
        printLn("<form id='password_reset' action='change_password.php' method='post'>");
        printLn("<input autocomplete='current-password' id='current-password' type='password' name='current-password' placeholder='Jelenlegi jelszó'><br>");
        printLn("<input autocomplete='new-password' id='new-password' type='password' name='new-password' placeholder='Új jelszó'><br>");
        printLn("<input autocomplete='new-password-confirm' id='new-password-confirm' type='password' name='new-password-confirm' placeholder='Új jelszó megerősítése'><br>");
        printLn("<input type='hidden' name='change' value='yes'>");
        printLn("<br><button type='submit'>Jelszó megváltoztatása</button>");
        printLn("</form>");
        printLn("</div>");
